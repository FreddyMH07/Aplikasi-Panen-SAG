...
<body class="bg-white text-gray-900" x-data="{ 
    ...
    <div class="flex h-screen overflow-hidden">
        <!-- Sidebar -->
    <div class="sidebar-transition fixed inset-y-0 left-0 z-50 flex flex-col bg-white shadow-lg"
             ...
             <div class="flex items-center w-full"
                ...
                <div x-show="sidebarOpen || sidebarHover" x-transition.opacity.duration.200ms
                    class="whitespace-nowrap">
                                        <span class="text-gray-800 font-bold text-sm block leading-tight">PT Sahabat Agro Group</span>
                                        <span class="text-gray-500 text-xs block leading-tight">Sistem Panen</span>
                </div>
             </div>
          </div>
            ...
            <nav class="flex-1 px-2 py-4 space-y-2 overflow-y-auto">
                <!-- Dashboard -->
                     <a href="{{ route('dashboard') }}" 
                         class="flex items-center px-3 py-2 text-gray-700 rounded-lg hover:bg-gray-100 transition-colors duration-200 {{ request()->routeIs('dashboard') ? 'bg-green-100 text-green-700' : '' }}">
            ...
            <button @click="open = !open" 
                class="flex items-center w-full px-3 py-2 text-gray-700 rounded-lg hover:bg-gray-100 transition-colors duration-200">
                    ...
                    <div x-show="open && (sidebarOpen || sidebarHover)" 
                         ...
                         class="ml-6 mt-2 space-y-1">
                                <a href="{{ route('panen-harian.index') }}" 
                                    class="flex items-center px-3 py-2 text-sm text-gray-600 rounded-lg hover:bg-gray-100 transition-colors duration-200 {{ request()->routeIs('panen-harian.*') ? 'bg-green-50 text-green-600' : '' }}">
                            <i class="fas fa-calendar-day w-4 h-4"></i>
                            <span class="ml-2">Report Harian</span>
                        </a>
                                <a href="{{ route('panen-bulanan.index') }}" 
                                    class="flex items-center px-3 py-2 text-sm text-gray-600 rounded-lg hover:bg-gray-100 transition-colors duration-200 {{ request()->routeIs('panen-bulanan.*') ? 'bg-green-50 text-green-600' : '' }}">
                    ...
                    <div x-show="open && (sidebarOpen || sidebarHover)" 
                         ...
                         class="ml-6 mt-2 space-y-1">
                                <a href="{{ route('kpi.index') }}" 
                                    class="flex items-center px-3 py-2 text-sm text-gray-600 rounded-lg hover:bg-gray-100 transition-colors duration-200 {{ request()->routeIs('kpi.index') ? 'bg-green-50 text-green-600' : '' }}">
                            <i class="fas fa-list w-4 h-4"></i>
                            <span class="ml-2">Overview</span>
                        </a>
                                <a href="{{ route('kpi.rekonsiliasi') }}" 
                                    class="flex items-center px-3 py-2 text-sm text-gray-600 rounded-lg hover:bg-gray-100 transition-colors duration-200 {{ request()->routeIs('kpi.rekonsiliasi') ? 'bg-green-50 text-green-600' : '' }}">
                            <i class="fas fa-balance-scale w-4 h-4"></i>
                            <span class="ml-2">Rekonsiliasi</span>
                        </a>
                                <a href="{{ route('kpi.restan') }}" 
                                    class="flex items-center px-3 py-2 text-sm text-gray-600 rounded-lg hover:bg-gray-100 transition-colors duration-200 {{ request()->routeIs('kpi.restan') ? 'bg-green-50 text-green-600' : '' }}">
                            <i class="fas fa-exclamation-triangle w-4 h-4"></i>
                            <span class="ml-2">Restan</span>
                        </a>
                                <a href="{{ route('kpi.budget') }}" 
                                    class="flex items-center px-3 py-2 text-sm text-gray-600 rounded-lg hover:bg-gray-100 transition-colors duration-200 {{ request()->routeIs('kpi.budget') ? 'bg-green-50 text-green-600' : '' }}">
                            <i class="fas fa-wallet w-4 h-4"></i>
                            <span class="ml-2">Budget</span>
                        </a>
                                <a href="{{ route('kpi.produktifitas') }}" 
                                    class="flex items-center px-3 py-2 text-sm text-gray-600 rounded-lg hover:bg-gray-100 transition-colors duration-200 {{ request()->routeIs('kpi.produktifitas') ? 'bg-green-50 text-green-600' : '' }}">
                            <i class="fas fa-user-check w-4 h-4"></i>
                            <span class="ml-2">Produktivitas</span>
                        </a>
                                <a href="{{ route('kpi.quality') }}" 
                                    class="flex items-center px-3 py-2 text-sm text-gray-600 rounded-lg hover:bg-gray-100 transition-colors duration-200 {{ request()->routeIs('kpi.quality') ? 'bg-green-50 text-green-600' : '' }}">
                            <i class="fas fa-gem w-4 h-4"></i>
                            <span class="ml-2">Quality</span>
                        </a>
                                <a href="{{ route('kpi.anomali') }}" 
                                    class="flex items-center px-3 py-2 text-sm text-gray-600 rounded-lg hover:bg-gray-100 transition-colors duration-200 {{ request()->routeIs('kpi.anomali') ? 'bg-green-50 text-green-600' : '' }}">
                            <i class="fas fa-bug w-4 h-4"></i>
                            <span class="ml-2">Anomali</span>
                        </a>
                                <a href="{{ route('kpi.summary') }}" 
                                    class="flex items-center px-3 py-2 text-sm text-gray-600 rounded-lg hover:bg-gray-100 transition-colors duration-200 {{ request()->routeIs('kpi.summary') ? 'bg-green-50 text-green-600' : '' }}">
                    ...
                    <div x-show="open && (sidebarOpen || sidebarHover)" 
                         ...
                         class="ml-6 mt-2 space-y-1">
                                <a href="{{ route('master.master-data.index') }}" 
                                    class="flex items-center px-3 py-2 text-sm text-gray-600 rounded-lg hover:bg-gray-100 transition-colors duration-200 {{ request()->routeIs('master.master-data.*') ? 'bg-green-50 text-green-600' : '' }}">
                            <i class="fas fa-table w-4 h-4"></i>
                            <span class="ml-2">Data Master</span>
                        </a>
                        @if (config('app.show_legacy'))
                                <a href="{{ route('master.kebun.index') }}" 
                                    class="flex items-center px-3 py-2 text-sm text-gray-600 rounded-lg hover:bg-gray-100 transition-colors duration-200 {{ request()->routeIs('master.kebun.*') ? 'bg-green-50 text-green-600' : '' }}">
                            <i class="fas fa-map w-4 h-4"></i>
                            <span class="ml-2">Kebun (Legacy)</span>
                        </a>
                                <a href="{{ route('master.divisi.index') }}" 
                                    class="flex items-center px-3 py-2 text-sm text-gray-600 rounded-lg hover:bg-gray-100 transition-colors duration-200 {{ request()->routeIs('master.divisi.*') ? 'bg-green-50 text-green-600' : '' }}">
                        ...
                        <div class="relative" x-data="{ open: false }">
                            ...
                            <div x-show="open" 
                                ...
                                <div class="px-4 py-2 border-b border-gray-200">
                                    <p class="text-sm text-gray-700 font-medium">{{ $userName ?? 'User' }}</p>
