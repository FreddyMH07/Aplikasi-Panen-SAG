    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        <div class="p-6 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-xl font-semibold text-gray-900">Tambah Master Data</h2>
                    <p class="text-gray-600 mt-1">Masukkan data master kebun, divisi, SPH, luas TM, dan budget</p>
                </div>
        ...
        <form action="{{ route('master.master-data.store', [], false) }}" method="POST" class="p-6">
            @csrf
