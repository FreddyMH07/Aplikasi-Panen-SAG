...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-4 sm:space-y-0">
        <div>
            <h2 class="text-2xl font-bold text-gray-900">Master Kebun (Legacy)</h2>
            <p class="text-gray-600">Kelola data master kebun untuk kompatibilitas sistem lama</p>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div class="p-6">
            <div class="overflow-x-auto">
                <table id="kebunTable" class="w-full text-sm text-left text-gray-600">
